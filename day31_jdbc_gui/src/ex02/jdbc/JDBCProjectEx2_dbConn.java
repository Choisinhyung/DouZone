...
public class JDBCProjectEx2_dbConn extends JFrame implements ActionListener{
	//component 객체 선언
	...
	public void dbConnect() {
		try {
			...
			pstmtTotalScroll = conn.prepareCall(sqlSelect, ResultSet.TYPE_SCROLL_SENSITIVE, 
