...
public class TcpMultiChatClient {
    public static void main(String[] args) {
        ...
        try {
             ...
             * 따라서 상대방이 보낸 데이터를 읽는 스레드와 메세지를 입력받아 상대방에게 전송하는 스레드를 분리하여 구현하면, 상대방의 데이터를 읽을때까지 프로그램이 멈춰있지 않게된다.
             *
             */
    ...
    static class ClientSender extends Thread{ // inner class
        ...
        public void run() { // override 된것을 확인할 수 있다. 이는 Runnable interface의 run 함수를 오버라이딩한 것이다.
            ...
            try {
                ...
                while(dos!=null)dos.writeUTF("[" + name + "]" + sc.nextLine());  // 이후 while문을 돌면서, [이름]:채팅 내용 을 UTF형식으로 전송한다.
            } catch (Exception e) {
                e.printStackTrace();
            }
        } // end run()
